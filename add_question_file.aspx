<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="add_question_file.aspx.cs" Inherits="add_question_file" %>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1" CssClass="form-control" DataTextField="campany_name" DataValueField="campany_name"></asp:DropDownList>
                            ...
                            <div class="form-group">
                            <asp:Button ID="Button1" runat="server" CssClass="btn btn-default" OnClick="Button1_OnClick" Text="Insert" />
                                </div>
                             </div>
                        <!-- /.col-lg-6 (nested) -->
                    </div>
