...
(function() {
    ...
    var _transport = function(opts) {
        if ((!fleegix || typeof fleegix.xhr === "undefined") && (!$ || typeof $.ajax === "undefined")) {
            throw new
                Error("Please use the Fleegix.js XHR module, jQuery ajax, Zepto ajax, or define your own transport mechanism for downloading zone files.");
        }
        if (!opts) return;
    ...
    timezoneJS.Date.prototype = {
        ...
        setFromDateObjProxy: function(dt) {
            ...
            this._day = dt.getDay();
            this._dateProxy = dt;
            this._timeProxy = Date.UTC(this.year,
                this.month,
                this.date,
                this.hours,
                this.minutes,
    ...
    timezoneJS.timezone = new function() {
        ...
        function getRule(dt, zone, isUTC) {
            ...
            var convertRuleToExactDateAndTime = function(yearAndRule, prevRule) {
                ...
                if (EXACT_DATE_TIME[year][rule])
                    ...
                    if (!isNaN(rule[4])) {
                        effectiveDate = new Date(Date.UTC(year,
                            SHORT_MONTHS[rule[3]],
                            rule[4],
                            hms[1],
                            hms[2],
                    ...
                    //Let's hunt for the date.
                        ...
                        if (rule[4].substr(0, 4) === "last") {
                            ...
                            effectiveDate = new Date(Date
                                .UTC(year, SHORT_MONTHS[rule[3]] + 1, 1, hms[1] - 24, hms[2], hms[3], 0));
                        ...
                        //Example: `Sun>=15`
                            ...
                            effectiveDate = new Date(Date
                                .UTC(year, SHORT_MONTHS[rule[3]], rule[4].substr(5), hms[1], hms[2], hms[3], 0));
        ...
        this.zoneFiles = [
            "africa", "antarctica", "asia", "australasia", "backward", "etcetera", "europe", "northamerica",
        ...
        this.loadZoneFile = function(fileName, opts) {
            if (typeof this.zoneFileBasePath === "undefined") {
                throw new
                    Error("Please define a base path to your zone file directory -- timezoneJS.timezone.zoneFileBasePath.");
            }
