        ...
        var curveslengths = {},
            ...
            getLengthFactory = function(istotal, subpath) {
                return function(path, length, onlystart) {
                    ...
                    point = istotal
                        ? len
                        : subpath ? subpaths : R.findDotsAtSegment(x, y, p[0], p[1], p[2], p[3], p[4], p[5], 1);
            ...
            if (font) {
                ...
                for (var i = 0, ii = letters.length; i < ii; i++) {
                    ...
                    if (curr && curr.d) {
                        ...
                        [
                            "t", shift * scale, shifty * scale, "s", scale, scale, top, height, "t", (x - top) / scale,
                            (y - height) / scale
                        ]);
                    }
                }
                                ...
                                if (!clr.error) {
                                    ...
                                    if ("opacity" in attrs || "fill-opacity" in attrs) {
                                        var gradient = R._g.doc
                                            .getElementById(node.getAttribute("fill").replace(/^url\(#|\)$/g, E));
                                        if (gradient) {
        ...
        (function() {
            ...
            R._engine.initWin = function(win) {
                ...
                try {
                    ...
                    createNode = function(tagName) {
                        return doc
                            .createElement("<" + tagName + ' xmlns="urn:schemas-microsoft.com:vml" class="rvml">');
                    };
                }
            };
