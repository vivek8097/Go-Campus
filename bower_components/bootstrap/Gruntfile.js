...
module.exports = function(grunt) {
    ...
    Object.keys(configBridge.paths)
    ...
    [
        "less-compile", "autoprefixer:core", "autoprefixer:theme", "csscomb:dist", "cssmin:minifyCore",
        "cssmin:minifyTheme"
    ]);
    ...
    grunt.registerTask("build-raw-files",
    ...
    [
        "docs-css", "lint-docs-css", "docs-js", "lint-docs-js", "clean:docs", "copy:docs", "build-glyphicons-data",
        "build-customizer"
    ]);
    ...
    grunt.registerTask("_update-shrinkwrap",
        function() {
            var done = this.async();
