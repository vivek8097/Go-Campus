...
(function(register, global, undefined) {
    ...
    var Holder = {
        ...
        run: function(userOptions) {
            ...
            if (App.setup.renderers.join(",").indexOf(renderSettings.renderer) === -1) {
                renderSettings.renderer = App.setup
                    .supportsSVG
                    ? "svg"
                    : (App.setup.supportsCanvas ? "canvas" : "html");
            }
            ...
            for (i = 0; i < objects.length; i++) {
                ...
                var objectHasDataSrcURL = objectAttr
                    .dataSrc !=
                    null &&
    ...
    function prepareDOMElement(mode, el, flags, _renderSettings) {
        ...
        if (flags.font) {
            ...
            if (!renderSettings.noFontFallback &&
        ...
        if (mode == "image" || mode == "fluid") {
            ...
            {
                'alt': (theme.text
                    ? (theme.text.length > 16 ? theme.text.substring(0, 16) + "…" : theme.text) +
                    " [" +
                    dimensionsCaption +
                    "]"
                    : dimensionsCaption)
    ...
    function buildSceneGraph(scene) {
        ...
        case "exact":
            ...
            scene.text = Math.floor(scene.flags.exactDimensions.width) +
                "x" +
    ...
    var stagingRenderer = (function() {
        ...
        return function(graph) {
            ...
            if (App.setup.supportsSVG) {
                ...
                var lineCount = Math.ceil(stagingTextBBox
                    .width /
                    (rootNode.properties.width * App.setup.lineWrapRatio));
    ...
    var sgCanvasRenderer = (function() {
        ...
        return function(sceneGraph) {
            ...
            ctx.font = textGroup.properties.font.weight +
                " " +
                App.dpr(textGroup.properties.font.size) +
    ...
    var SceneGraph = function(sceneProperties) {
        ...
        var RootNode = augment(SceneNode,
            function(uber) {
    ...
    if (global.onDomReady) {
        global.onDomReady(function() {
            ...
            if (typeof global.Turbolinks == "object") {
                global.document.addEventListener("page:change",
                    function() {
                        Holder.run();
                    });
            }
