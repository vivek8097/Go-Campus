...
// Internet Explorer sometimes struggles to read currentStyle until the element's document is accessed.
        ...
        return suffix == "%"
            ...
            : suffix == "mm"
            ? size * 0.3937 * 96 / 10
            : suffix == "pc" ? size * 12 * 96 / 72 : suffix == "pt" ? size * 96 / 72 : size;
    }
    ...
    function setShortStyleProperty(style, property) {
        ...
        style[property] = (style[t] == style[r] && style[t] == style[b] && style[t] == style[l]
                ...
                ? [style[t], style[r]]
                : style[l] == style[r] ? [style[t], style[r], style[b]] : [style[t], style[r], style[b], style[l]])
            .join(" ");
    }
    ...
    function CSSStyleDeclaration(element) {
        ...
        for (property in currentStyle) {
            Array.prototype.push.call(style,
                property == "styleFloat" ? "float" : property.replace(/[A-Z]/, unCamelCase));
            if (property == "width") {
    ...
    CSSStyleDeclaration.prototype = {
        ...
        getPropertyValue: function(property) {
            var lookup = property.replace(/-([a-z])/g,
                function(match) {
