...
$.fn.dataTableExt.oPagination.listbox = {
    ...
    "fnInit": function(oSettings, nPaging, fnCallbackDraw) {
        ...
        $(nInput)
            .change(function(e) { // Set DataTables page property and redraw the grid on listbox change event.
    ...
    "fnUpdate": function(oSettings, fnCallbackDraw) {
        ...
        var iCurrentPage = Math.ceil(oSettings
                ._iDisplayStart /
                oSettings._iDisplayLength) +
            1; /* Loop over each instance of the pager */
