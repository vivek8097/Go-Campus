...
// CommonJS require()
    ...
    require.register("browser/debug.js",
    ...
    require.register("browser/diff.js",
        function(module, exports, require) {
        ...
        createPatch: function(fileName, oldStr, newStr, oldHeader, newHeader) {
            ...
            for (var i = 0; i < diff.length; i++) {
                ...
                if (current.added || current.removed) {
                    ...
                    curRange.push.apply(curRange,
                        lines.map(function(entry) { return (current.added ? "+" : "-") + entry; }));
...
require.register("browser/events.js",
    function(module, exports, require) {
...
require.register("browser/fs.js",
    function(module, exports, require) {

    }); // module: browser/fs.js

require.register("browser/path.js",
    function(module, exports, require) {

    }); // module: browser/path.js

require.register("browser/progress.js",
    function(module, exports, require) {
/**
 * Expose `Progress`.
 */
...
require.register("browser/tty.js",
    function(module, exports, require) {
...
require.register("interfaces/bdd.js",
    function(module, exports, require) {
...
require.register("interfaces/exports.js",
    function(module, exports, require) {
...
require.register("interfaces/index.js",
    function(module, exports, require) {
...
require.register("interfaces/qunit.js",
    function(module, exports, require) {
...
require.register("interfaces/tdd.js",
    function(module, exports, require) {
...
require.register("reporters/base.js",
    function(module, exports, require) {
...
function canonicalize(obj, stack) {
    ...
    if ("[object Array]" == {}.toString.call(obj)) {
        stack.push(obj);
        canonicalizedObj = utils.map(obj,
            function(item) {
        ...
        stack.push(obj);
        canonicalizedObj = {};
        utils.forEach(utils.keys(obj).sort(),
            function(key) {
...
require.register("reporters/dot.js",
    function(module, exports, require) {
...
require.register("reporters/html-cov.js",
    function(module, exports, require) {
...
require.register("reporters/html.js",
    function(module, exports, require) {
    ...
    runner.on("test end",
        function(test) {
            ...
            if ("passed" == test.state) {
                ...
                var el =
                    fragment('<li class="test pass %e"><h2>%e<span class="duration">%ems</span> <a href="%s" class="replay">‣</a></h2></li>', test.speed, test.title, test.duration, url);
            } else if (test.pending) {
                var el = fragment('<li class="test pass pending"><h2>%e</h2></li>', test.title);
            } else {
                var el = fragment('<li class="test fail"><h2>%e <a href="?grep=%e" class="replay">‣</a></h2></li>',
                    test.title,
...
function fragment(html) {
    ...
    div.innerHTML = html.replace(/%([se])/g,
        function(_, type) {
            switch (type) {
            case "s":
...
require.register("reporters/index.js",
    function(module, exports, require) {
...
require.register("reporters/json-cov.js",
    function(module, exports, require) {
...
require.register("reporters/json-stream.js",
    function(module, exports, require) {
...
require.register("reporters/json.js",
    function(module, exports, require) {
...
require.register("reporters/landing.js",
    function(module, exports, require) {
...
require.register("reporters/list.js",
    function(module, exports, require) {
...
require.register("reporters/markdown.js",
    function(module, exports, require) {
/**
 * Module dependencies.
 */
...
require.register("reporters/min.js",
    function(module, exports, require) {
...
require.register("reporters/nyan.js",
    function(module, exports, require) {
/**
 * Module dependencies.
 */
...
require.register("reporters/progress.js",
    function(module, exports, require) {
...
require.register("reporters/spec.js",
    function(module, exports, require) {
...
require.register("reporters/tap.js",
    function(module, exports, require) {
...
require.register("reporters/xunit.js",
    function(module, exports, require) {
...
Runner.prototype.runTests = function(suite, fn) {
    ...
    function hookErr(err, errSuite, after) {
        ...
        if (self.suite) {
            ...
            self.hookUp("afterEach",
                function(err2, errSuite2) {
                    self.suite = orig;
...
Suite.prototype.total = function() {
    return utils.reduce(this.suites,
            function(sum, suite) {
...
exports.parseQuery = function(qs) {
    return exports.reduce(qs.replace("?", "").split("&"),
        function(obj, pair) {
...
mocha.throwError = function(err) {
    Mocha.utils.forEach(uncaughtExceptionHandlers,
        function(fn) {
            fn(err);
        });
    throw err;
