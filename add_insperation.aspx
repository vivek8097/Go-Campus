<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="add_insperation.aspx.cs" Inherits="add_insperation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" Runat="Server">
    ...
    <div class="form-group">
        ...
        <asp:DropDownList ID="ddtype" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddtype_SelectedIndexChanged" AutoPostBack="True">
    ...
    <div align="center">
        &nbsp;<asp:Button id="btninsert" Text="Insert" runat="server" OnClick="btninsert_OnClick" CssClass="btn btn-default"></asp:Button>
    </div>
</asp:Content>